    ...
    if 2 < len(message.text) < 50:    
        ...
        if len(btn) > 10: 
            ...
            await message.reply_text(
                f"<b> A hnuai ami te hi {message.text} te chu an ni e</b>",
    ...
    if (clicked == typed) or (clicked in AUTH_USERS):
        ...
        if query.data.startswith("next"):
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("⭕️ JOIN OUR GROUP ⭕️", url="https://t.me/puituflynn")]
            ])
            ...
            keyboard = InlineKeyboardMarkup([
                [InlineKeyboardButton("BACK", callback_data="start_data"),
                    InlineKeyboardButton("ABOUT", callback_data="about_data")],
                [InlineKeyboardButton("⭕️ Developer ⭕️", url="https://t.me/Didiktea")]
            ])
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("Youtube Channel", url="https://m.youtube.com/channel/UCRVFdrBy_I-_hNL3vgONbuQ")]
            ])
